...
(e) Use the result of part (d) to approximate your error in computing the edge length of the cube if the cube's actual volume is $7.7\text{cm}^3$.

(f) Explain how this question is related to Question 4.
...
\begin{hint}
\[
        r = f(v) = \answer{\frac{3v}{168-v}} , 60\leq v \leq 72 .
\]
\end{hint}
