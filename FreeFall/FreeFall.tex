...
In the context of a rock dropped from rest, this means that the rock's speed at any time $t$ is twice its average speed during the time interval from the moment of release to time $t$. %We can see this by writing the derivative
%\[
