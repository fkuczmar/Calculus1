...
\begin{onlineOnly}
    \begin{center}
\desmos{hodpduouni}{900}{600}
\end{center}
\end{onlineOnly}

Access Desmos interactives through the online version of this text at
 
\href{https://https://www.desmos.com/calculator/hodpduouni}{151: Reflective Property of Ellipses Statuary Hall}.
...
A point $P$ with coordinates $(x,y)$ lies on the ellipse if and only if
\[
    \sqrt{x^2 + y^2} + \sqrt{\answer{(x-4)^2 + y^2}} = \answer{8}
\]

\item Use implicit differentiation and the equation in part (a) directly to find the slope of the tangent line to the ellipse at $P(0,3)$.

\item Find an equation of the normal line at $P$. Enter this equation on Line 16 in the worksheet above. 

\item Use algebra to find the coordinates of the point $N$ where the normal line intersects the $x$-axis.

\item Use right triangle trigonometry to find the exact measure of $\angle F_1 P N$.

\item Use the law of Sines in $\Delta PNF_2$ to find the exact measure of $\angle F_2PN$.
