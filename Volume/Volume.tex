...
\section{Triangle and Cones}


\begin{question}  \label{QOERre4334}

Use integration to find an expression for the area of $\Delta ABC$ below in terms of its base $b=AC$ and height $h=BS$. 
...
Use integration to express the volume of the red cone in terms of the area $A$ of its base and its height $h=BS$. 
