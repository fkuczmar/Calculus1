...
\[
      s = f(s) = 1.22\sqrt{s}, 0\leq s \leq 20,000,
\]
...
Go through a similar analysis as in parts (a)-(e) of Example 1, to approximate the change $\Delta s$ in the distance to the horizon in terms of the change $\Delta h = h-25$ in your height above the ground.
