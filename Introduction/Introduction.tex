...
\begin{center}
  \begin{tabular}{ | c| c | c | c | c |}
    \hline
    $h$ (ft) & $s = f(h)$ (miles) & $\Delta h = s-165$ (miles)  & $\Delta s =f(h) - f(165)$ (miles) & $\Delta s/\Delta h \, (units?)$ \\ \hline
     $162$ &  &  &   & \\ \hline
    $163$ &  &  &   & \\ \hline
    $164$ &  &  &   &  \\ \hline
    $165$  &  &  &  &   \\ \hline
...
\[
  \Delta s \sim \answer{3.291} \Delta h .
\] 

(f) Explain the meaning of the proportionality constant above. Be sure to include units in your explanation.
