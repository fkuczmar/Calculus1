...
\begin{question} \label{Qgh424r4rghghg}
...
\]
that expresses the polar angle (meausred in radians) of the beetle (more precisely of the vector giving the beetle's position relative to the origin) in terms of the number of minutes past noon. Explain your reasoning.

Include a graph of the function $\theta=f(t)$ to help with your explanation. 

Include units for each number in each calulation.
