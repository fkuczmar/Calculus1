...
(i) You know two lengths in right triangle $\Delta OPT$. What are they, measured in feet?
\[
      OT = \answer{3960}
\]
and
...
(ii) Let $\theta$ be the radian measure of $\angle TOP$. Write an equaion with a trigonometric function of $\theta$ that relates the two lengths in part (i). You will need to use the Math Editor tab to enter the trig function and the angle $\theta$.
\[
...
(iii) Now solve the equation from part (ii) for $\theta$ in terms of $h$. Then use what you know about measuring arclength along a circle to find an expression for the function $f$.
\[
