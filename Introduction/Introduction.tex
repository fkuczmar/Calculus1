...
(i) You know two lengths in right triangle $\Delta OPT$. What are they?
\[
      OT = \answer{3960}
\]
and
...
(ii) Let $\theta$ be the radian measure of $\angle TOP$. Write an equaion with a trigonometric function of $\theta$ that relates the two lengths in part (i).
\[
