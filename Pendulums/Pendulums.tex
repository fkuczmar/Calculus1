...
Summing these differential distances along the cycloid measured from $A$ (where $\theta=\pi$) to the point $P$ with parameter $\theta$ gives the distance $AP$ along the cycloid as
...
Here we have two choices. One is to stick with the parameter $\theta$. Then
