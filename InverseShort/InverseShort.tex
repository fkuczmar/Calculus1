...
\[
     \frac{dG}{dG} = \left( \frac{s+23}{1000} \right)  \left( \answer{\frac{ds}{dG}}  \right) .
\]
...
Use the results of Exercise \ref{Eggghhybvbxzzz} to express the derivative of the inverse of each of the functions in that exercise in terms of its independent variable.
\end{exercise}
