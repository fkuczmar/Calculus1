...
But now we run into two problems. The first is that double integrals our not part of this class. The second is that even if they were, it's still not clear how to evaluate this double integral.
