...
\title{An Introduction to Differentiable Functions, Part 1}
...
\]
expresses the temperature (in $^\circ$C) of a cup of coffee in terms of the number of minutes past noon. It's graph is shown below.
...
\begin{enumerate}
\item Zoom in close enough to the point $P$ above to make the graph look like a straight line. Then approximate the slope of this line. Include units. Then interpret the meaning of the slope in part (a) in the context of this scenario.

\begin{freeResponse}
\end{freeResponse}


%Use the resut of part (a) to interpret the value and the meaning of the derivative
%\[
%   \frac{dT}{dm} \Big|_{T=40} .
%\]

\item Repeat part (a) for other temperatures by dragging the slider $T_0$ in Line 2 of the worksheet above. Make a table with two columns, temperature and slope. Then look for a relationship between the temperature $T$ and the rate at which the temperature of the coffee is changing. Summarize your observations.
\begin{freeResponse}
\end{freeResponse}

\end{enumerate}

You should have found at the moment the coffee's temperature is $40^\circ$C, its temperature is decreasing at the rate of $2^\circ$C/min. We write this sybmolically as
\[
...
\begin{example} \label{Exmefr3r430}
...
\begin{onlineOnly}
    \begin{center}
\desmos{59nrhmvrka}{450}{600}  
\end{center}
\end{onlineOnly}

\href{https://www.desmos.com/calculator/59nrhmvrka}{151: Complex Squaring Function 2}
