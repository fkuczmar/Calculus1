...
\item Use the graph approximate the end of the time interval beginning at 9am during over the price decreases at the greatest average rate. 

\item Use algebra to find the exact time.
