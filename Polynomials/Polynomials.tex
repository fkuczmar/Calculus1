...
\[
   S = g(t) \, , \, 0\leq t \leq 8 ,
\]
that expresses the number of shares we can buy with $\$1,000$ in terms of the number of hours past 9am. Click the arrow to the lower right to check.

\begin{expandable}
This function is
\[
         S = g(t) = \frac{1000}{f(t)} \, , \, 0\leq t \leq 8 
\]
\end{expandable}
