...
\[
     r = g(a)
\]
that expresses the balloon's rate of ascent (measured in thousands of ft/hr) at time $t=t_0$ hours past noon in terms of  its average rate of ascent (measured in thousands of ft/hr) over the time interval $t\in [0,t_0]$.

(c) Interpret your result from part (b) geometrically on the graph of the function $f$. Follow the directions in the demonstration below to help explain your interpretation.
