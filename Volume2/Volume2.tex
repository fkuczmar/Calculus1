...
\item Drag the slider $a$ in Line 12 of the first worksheet to change the radius of the original sphere. How does the volume of the napkin ring change as you vary $a$? Try to explain this geometrically by dragging the same slider $a$ in Line 6 of the second worksheet. Keep your eye on the tangent cluster.
