...
\]
expresses the number of pounds of apples you can buy with $\$100$ in terms of the number of hours past 9am on April 23, 2005. 

The graph of the function $h=f(t)$ is shown below.

\begin{onlineOnly}
    \begin{center}
\desmos{gmacicx5qr}{450}{600}  
\end{center}
\end{onlineOnly}

\href{https://www.desmos.com/calculator/gmacicx5qr}{151: Apples Drought}

\begin{enumerate}

\item Let $a\in [08]$ be a constant. Interpret the meaning of the function
\[
   m(v) =  \frac{f(v)-f(a)}{v-a}
\]
in the context of this scenario. Include units. State the domain of the function as well.

\item Use the graph of the function $N=f(t)$ above and the slider $u$ to to sketch a rough graph of the function $r=m(v)$ when $a=5$. Label the axes with the appropriate variable names and units.

\item Activate the folder (avg. rate of change function) in Line 11 to check your graph of the function $r=m(v)$. 

\item Click on the appopriate points of the curve $r=m(v)$ to find the average rate of change (with respect to time) in the number of pounds of apples you can buy with $\$100$ between 
