...
\]
models the spread of a virus throughouot a population. It takes as an input the number of months since January 1st and returns as an output the number of infected individuals (measured in millions). Graph shown below.
