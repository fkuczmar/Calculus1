...
We could get around talking about an instantaneous growth rate by saying that the average growth rate over \emph{any} time interval is $0.5$ million bacteria/hour. This statement implies that the growth rate is constant. 
...
We could say that the population doubles every hour. Equivalently, we could say that the population increases by $100\%$ every hour. But neither of these descriptions would be complete. They don't tell us, nor do they imply, anything about what happens to the population over a half-hour period for example. The function $P=h(t)$ graphed below shows an example of a non-exponential function that doubles every hour. Drag the slider $u$ in Line 1 and keep your eye on Line 2 (where $h=1$, and $P=f_7(t)$) to convince yourself of this.
