...
\item Repeat part (a) for tangent lines parallel to the lines
\[
   x - 8y = 12
\]
and
\[
   8x + y = 12.
\]
Explain. Include a graph.
\end{enumerate}
\end{exercise}

\begin{exercise}
In the afternoon hours a $40$-foot tall building casts an $80$-foot long shadow.
...
\begin{enumerate}
\item Use the worksheet above to approximate the scaling factor that converts a small change in the inclination angle of the sun (in radians) to an accurate approximation to the change in the length of the shadow. Include units.
