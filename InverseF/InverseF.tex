...
\end{align*}
And for the cylindrical tank we can write Torricelli's law as
\[
   \frac{dV}{dt} =  \answer{\pi r^2} \frac{d\answer{h}}{d\answer{t}} = - k \sqrt{h} .
\]
Or equivalently as
\[
      \frac{dh}{dt} = - \frac{k}{\answer{\pi r^2}} \sqrt{h} = -k_1 \sqrt{h} ,
\]
where
\[
       k_1 = \frac{k}{\pi r^2}
...
(c) Which of the following functions might express the depth of water in a cylindrical tank (as a function of time) as the water drains out of a small hole in the bottom of the tank? Justify your reasoning.
...
While water is poured into a cylindrical tank at a constant rate, water leaks out through a small hole in the bottom of the tank.

The function 
\[
      t = f(h) = - \frac{2\sqrt{h}}{k_2} - \frac{2k_1}{k_2} \ln\left( \frac{k_1 - \sqrt{h}}{k_1}   \right) \, , \, t\geq 0 ,
\]
expresses the time (in seconds) in terms of the depth of the water (in feet), where $k_1$ and $k_2$ are postive constants.

(a) Find the depth of the water at time $t=0$.

(b) What are the units of $k_1$, $k_2$? Explain your reasoning.

(c) FInd a function 
\[
      r = g(h) \, , h\geq 0,
\]
that expresses the rate (in ft/sec) at which the water level in the tank is changing in terms of the depth of the water (in feet). Briefly explain your reasoning. Do \emph{not} use implicit differentiation. Simplify the function.
