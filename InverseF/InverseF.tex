...
The function 
\[
      t = f(h) = - \frac{2}{k_2}  \left( \sqrt{h} - \sqrt{h_0} + \frac{k_1}{k_2} \ln \Bigg| \frac{k_1 - k_2 \sqrt{h}}{k_1 - k_2 \sqrt{h_0}}   \Bigg| \right)\, , \, t\geq 0 ,
\]
...
\begin{onlineOnly}
    \begin{center}
\desmos{el0ef9mbbu}{900}{600}
\end{center}
\end{onlineOnly}

Worksheet available at \href{https://www.desmos.com/calculator/el0ef9mbbu}{151: Draining Cylinder 2}



(a) Show that the depth of the water at time $t=0$ is $h=h_0$.
