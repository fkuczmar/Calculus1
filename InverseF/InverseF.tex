...
We found that
\[
    \frac{dV}{ds}\Big|_{V=\answer{8}} = \answer{1/12}. 
\]
...
But all this work took us back to the same approximate relation between the two errors $\Delta V$ and $\Delta s$ that we had already found in solving the first problem.
...
\[
        \frac{ds}{dV}\Big|_{V=\answer{8}} = \answer{1/22}.
\]
