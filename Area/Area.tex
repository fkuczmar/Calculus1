...
Now slice the region into differential rectangles perpendicular to the $x$-axis. Then the general differential rectangle $PQ$ with endpoints $P(x, a\cos(x/k))$ and $Q(x,b\sin(x/k))$  has differential area
\[
