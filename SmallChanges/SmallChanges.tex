...
\section{Odometer Readings, Part 1}
...
(e) Does  your table from part (d) suggest that the ratio $\Delta t/ \Delta s$ approaches some number as $s \to 160$? If so, approximate the value of this number. What are its units?
