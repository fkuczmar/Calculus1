...
Next, solve for $t$ in terms of $s$.
\[
    t = \answer{\frac{\sqrt{3}}{2}s}  \pm \answer{\sqrt{100-\frac{s^2}{4}}}
\]

Finally, make the correct choice of $\pm$ to solve for $t$ in terms of $s$, when $s$ is near $16$ and $t$ near $8$.
\[
