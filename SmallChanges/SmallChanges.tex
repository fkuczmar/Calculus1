...
The main idea of differential calculus is that for some functions (called \emph{differentiable}) the change in the output is approximately proportional to the change in the input. The proportionality factor is called the derivative. In this chapter we explore this idea.
