...
Relative changes and relative errors are often more meaningful than absolute changes and errors. For example, I might measure the distance from Shoreline's Central Market to the Richmond beach library to be $5$ km with an  error of at most $0.2$ miles, while NASA might measure the between the earth and the moon on the first day of spring to be $384,400$ km with an error of at most $100$ km. The relative error in my measurement is at most
\[
  \frac{0.2 \text{ miles} }{5 \text{ miles}} = 0.04 = 4\% ,
\] 
...
Suppose between noon and 10pm a colony of bacteria grows exponentially. The population is $200,000$ at noon and $220,000$ at 1pm.
...
(c) Determine the relative averge growth rate between 1pm and 2pm. Between 3pm and 4pm. Over any one hour time period.

(d) Approximate the instantaneous relative growth rate at 1pm and at 3pm. 
