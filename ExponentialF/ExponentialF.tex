...
(b) Find an expression for the relative (average) growth rate between time $u$ hours past noon and time $u+h$ hours past noon. Measure the rate relative to the population at time $u$.
...
(f) Use limits to write an expression for the relative (instantaneous) growth rate at time $t=u$ hours past noon. Simplify this expression as much as possible.

(g) Interpret your expression from part (f) as the derivative of a specific function evaluated at a specific input. What does this tell you?
