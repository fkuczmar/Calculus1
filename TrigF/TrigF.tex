...
\item The wheel stops when you are $100$ feet above the for the first time. It then starts again and turns through a small angle of $\Delta \theta$ radians before stopping again.


\begin{onlineOnly}
    \begin{center}
\desmos{7mmcytoxg8}{900}{600}
\end{center}
\end{onlineOnly}
...
\item Use a deriviative to approximate the change $\Delta h$ in your height (measured in feet) as the wheel turned through the small angle $\Delta \theta$ radians.
