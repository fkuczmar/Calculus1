...
\]
expresses the rotation angle (in radians, measured since you boarded the wheel) in terms of the number of seconds since  you got on. Use the graph of this function to approximate the your rate of ascent at time $t=40$ seconds. 
