...
\] 
Do \emph{not} make any computations. Just use the demonstration below.
...
\item{A discussion of where a small change in the input to $f$ gives the greatest positive change and a consideration of the ratios of these changes }

\item{A discussion of where a small change in the input to $f$ gives the greatest positive change and a consideration of the ratios of these changes }

{A discussion of where a small change in the input to $f$ barely changes the output and a consideration of the ratios of these changes }
