...
\begin{onlineOnly}
    \begin{center}
\desmos{gjmdl4rqii}{900}{600}  %    pxsmo04nmg  8swp20zond
\end{center}
\end{onlineOnly}

\href{https://www.desmos.com/calculator/gjmdl4rqii}{151: Trig 2}

Find exact answers to the following quetions without using a calculator.
