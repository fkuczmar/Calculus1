...
The aim of this proble is to use algebra to evaluate the derivative
\[
...
\item The idea to compute the derivative algebraically is this: Fix the point $P(1,1)$ on the graph of $y=f(x)=x^3$. Then choose a variable point $Q$ on the graph, different from $P$, with coordinates $(v,v^3)$. When $Q$ is sufficiently close to $P$, the line $PQ$ approximates the curve $y=x^3$ near $P(1,1)$ and the slope of this line is approximately equal to the derivative above. 
