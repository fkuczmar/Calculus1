...
\begin{onlineOnly}
    \begin{center}
\desmos{setzi2wme3}{450}{600}  
\end{center}
\end{onlineOnly}

\href{https://www.desmos.com/calculator/setzi2wme3}{151: Balloon}
...
\[
         r(v) = \frac{f(v)-f(2)}{v-2} .
\]

\item Write the domain of $r$ in set notation.

\item Open the table in Line 1 by clicking the circle at the left of the line. 
