...
We'll get back to applications a bit later. The next few examples focus on the geometric meaning of differentiability.

%how to compute the derivative algebraically for certain types of functions.
...
\]
Use the demonstration below to check your work for part (b) by dragging the sliders $v$ (Line 4) and $a$ (Line 16). Then activate the Derivative Function folder on Line 17.
...
Keep following the method of Exploration \ref{Exp9039000030} to evaluate the following derivatives.
