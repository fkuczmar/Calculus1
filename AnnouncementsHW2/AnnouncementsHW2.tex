...
\item Show \emph{all} steps in using the chain rule as in our class notes. You are resonsible for knowing what this means. See
the Explanations to Examples 1,2, and 3 here: \href{https://ximera.osu.edu/calcone/Calculus1/ChainRule/ChainRule}{The Chain Rule} for examples.
