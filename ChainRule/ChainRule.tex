...
(ii) Find a function $r=h(t)$ that expresses your rate of ascent (in ft/sec) in terms of the number of seconds since you boarded. Include the appropriate domain.
