...
\[
    \theta = f(t) , t \geq 0 ,
\]
expresses the radian measure of the angle of rotation angle of a ferris wheel in terms of the number of seconds since you boarded. The wheel has radius $r$ feet and its center is $b$ feet above the ground. 
