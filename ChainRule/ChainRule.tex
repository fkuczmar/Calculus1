...
Our goal is to use the graphs of the function $f$ and $g$ below (take the times $t$ to be postive, not negative as shown) to approximate your rate of ascent $t$ seconds after boarding. We'll do this in two different ways.

(a) The first way involves just one step. 
