...
\begin{exercise} \label{EXe9dr3r}
Do Question 2 in the chapter

\href{https://ximera.osu.edu/calcone/Calculus1/Volume2/Volume2}{Volumes, Part 2}

of our class notes by using trig functions to parameterize the circle of radius $a$ centered at the origin.
\end{exercise}
