...
For example, at the input $L=2$, we'll to first compute the \emph{average stretching factor} over the interval between lengths $L=2$ and $L=v$. This average rate of change is 
\begin{align*}
...
\item Repeat part (a) to approximate the stretching factor at the input $L=0.95$.
\end{enumerate}
