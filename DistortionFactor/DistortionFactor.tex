...
\begin{align*}
  \frac{\Delta H}{\Delta L} &= \frac{f(b) - f(a)}{b-a} \\
                                       ...
                                       &= \answer{2},
\end{align*}
is what we'll call the \emph{stretching factor}. Any two points on the stretched band are twice as far apart as they were on the unstretched band.

What are the units of the stretching factor?
\begin{freeResponse}
\end{freeResponse}
