...
(b) Find equations of all horizontal tangent lines to the above ellipse.
...
\begin{onlineOnly}
    \begin{center}
\desmos{gjqoet7s7d}{900}{600}
\end{center}
\end{onlineOnly}

Geogebra activity available at \href{https://www.desmos.com/calculator/gjqoet7s7d}{151: Tree and Ladder}
