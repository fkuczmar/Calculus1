...
(e) Hold $y$ constant and differentiate each side of equation (\ref{Eq:Wave1}) with respect to $t$ to find an expression for the speed of the wave. Explain. 

\begin{onlineOnly}
    \begin{center}
\desmos{apemomypje}{900}{600}
\end{center}
\end{onlineOnly}

Desmos activity available at \href{https://www.desmos.com/calculator/apemomypje}{151: Traveling Wave 1}
