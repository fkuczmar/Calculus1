...
(a) Play the slider $s$ in the demonstration below to show the motion of a beetle along the $y$-axis.
...
(c) Use the animation to (by hand) a graph of the function
\[
     v= g(t)
\]
that expresses the beetle's velocity (in this case the rate of change (with respect to time), in the beetle's $y$-coordinate) as a function of time. Label the axes with the appropriate variable names and units. Then activate the folder in Line 7 to see how you did.


\begin{onlineOnly}
    \begin{center}
\desmos{l77xphp5oj}{900}{600}
\end{center}
\end{onlineOnly}

Desmos activity available at \href{https://www.desmos.com/calculator/l77xphp5oj}{151: Tangent Motion}
