...
Find simplified expressions for each of the following derivatives. Find also the domain of each function being differentiated.
...
\item $\frac{d}{dx} \left( \ln  \sqrt{\frac{1-x}{1+x}} \right)$
\end{enumerate}
