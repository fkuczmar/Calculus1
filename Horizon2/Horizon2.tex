...
\item Now suppose we are $400$ km above the lunar surface. Fill in the missing entries in the table below to approximate the scaling factor that converts a small change 
\[
  \Delta h = h - 400
\]
...
\begin{center}
  \begin{tabular}{ | c| c | c | c | c |}
    \hline
    $h$ (km) & $s = f(h)$ (km) & $\Delta h = h-400$ (km)  & $\Delta s =f(h) - f(400)$ (km) & $\Delta s/\Delta h \, (units?)$ \\ \hline
     $397$ &  &  &   & \\ \hline
    $398$ &  &  &   & \\ \hline
    $399$ &  &  &   &  \\ \hline
    $400$  &  &  &  &   \\ \hline
...
\item Do the data above suggest that the quotients $\Delta s / \Delta h$ approach some number as $h$ approaches 400? If so, use the data to approximate that number. If not, explain why not.
