...
Find the  scaling factor that converts (by multiplication) a small change in the height of the ladder's top end above the base of the wall (in feet) to an accurate approximation of the corresponding change in the acute angle the ladder makes with the wall. Include units.
...
\begin{question} \label{Qdfef3r00} 
An elastic cord runs from the top of an $80$-foot tall tower to a point on the ground. % $50$ feet from the base of the tower. 
